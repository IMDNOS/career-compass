...
const request_activation_code_dto_1 = require("../employees/dto/request-activation-code.dto");
const activate_employee_dto_1 = require("../employees/dto/activate-employee.dto");
let CompanyAuthController = class CompanyAuthController {
    ...
    requestActivationCode(requestActivationCodeDto) {
        return this.companyAuthService.requestActivationCode(requestActivationCodeDto);
    }
    activateAccount(activateEmployeeDto) {
...
__decorate([
    (0, common_1.Post)('requestActivationCode'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [request_activation_code_dto_1.RequestActivationCodeDto]),
    __metadata("design:returntype", void 0)
], CompanyAuthController.prototype, "requestActivationCode", null);
__decorate([
    (0, common_1.Post)('activate'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [activate_employee_dto_1.ActivateEmployeeDto]),
    __metadata("design:returntype", void 0)
], CompanyAuthController.prototype, "activateAccount", null);
__decorate([
